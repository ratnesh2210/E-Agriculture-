...
<div class="btn-group pull-right">
 ...
 <div class="container-fluid text-center bg-grey">
    <div class="row">
<?php
  $sql=mysqli_query($connect,"SELECT * from upload_db where product_name LIKE '$name%' OR product_name LIKE '%$name%' OR product_name LIKE '%$name' order by product_name") or die("cannot do sql".mysqli_error($connect));
  $counter=1;
