      ...
      <button class="btn btn-info">Sort the displayed items</button>
          <button class="btn btn-info dropdown-toggle" data-toggle="dropdown">
            ...
            <ul class="dropdown-menu" role="menu" aria-labelledby="dropdownMenu">
              ...
              <li><a tabindex="-1" href="sort_low_to_high_farmer.php">Sort by price Low to High</a></li>
              <li><a tabindex="-1" href="sort_high_to_low_farmer.php">Sort by price High to Low</a></li>
            </ul>
  </div>
<br><br><br>
<div class="container">
...
$sql=mysqli_query($con,"SELECT * from upload_db where uploaded_by='$user' and exist='1'");
$counter=1;
