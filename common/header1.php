...
<nav class="navbar navbar-default navbar-fixed-top">
  <div class="container">
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="firstpage.php"><img src="image13.png" style="display: inline-block;"  style="height: 13px;
  width: 13px;"></a>
    </div>
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav navbar-right">
        ...
        <ul class="dropdown-menu">
          <li><a href="mumbaipage.php">Mumbai</a></li>
          <li><a href="gurgoanpage.php">Gurgoan</a></li>
      ...
      <input type="text" name="name" class="form-control input-md" size="30" placeholder="Search for the products" required>
