...
<div class="col-md-4" style="color:black"><u><h4>All products:</h4></div>    </u> 
<div class="btn-group pull-right">
 ...
 <div class="container-fluid text-center bg-grey">
    <div class="row">
<?php
  $sql=mysqli_query($connect,"SELECT * from upload_db") or die("cannot do sql".mysqli_error($connect));
  $counter=1;
